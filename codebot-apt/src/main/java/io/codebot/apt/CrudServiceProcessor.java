...
import io.codebot.apt.crud.AbstractCrudProcessor;
import io.codebot.apt.crud.JpaCrudProcessor;
...
public class CrudServiceProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (TypeElement serviceElement : ElementFilter.typesIn(roundEnv.getElementsAnnotatedWith(annotation))) {
            ...
            try {
                AbstractCrudProcessor crudProcessor = new JpaCrudProcessor();
                crudProcessor.init(processingEnv, serviceElement);
                crudProcessor.process();
            } catch (Exception e) {
