...
public class QuerydslJpaFindSnippet extends JpaFindSnippet<QuerydslJpaFindSnippet> {
    ...
    public QuerydslJpaFindSnippet setJpaSpecificationExecutor(CodeBlock jpaSpecificationExecutor) {
