...
public abstract class AbstractFindSnippet implements CodeSnippet<FindResult> {
    ...
    @Override
    public FindResult writeTo(CodeBuffer codeBuffer) {
    ...
    protected abstract FindResult findById(CodeBuffer codeBuffer, ContextVariable idVariable);

    protected abstract FindResult findAll(CodeBuffer codeBuffer);

    protected abstract FindResult find(CodeBuffer codeBuffer);
